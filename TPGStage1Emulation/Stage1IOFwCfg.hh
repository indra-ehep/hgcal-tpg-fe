...
public:
  ...
  Stage1IOFwCfg() {
	...
	for(unsigned j(0);j<MaximumUnpackersPerLpgbtPair;j++) {
	  _unpackerType[lp][j]=TPGFEDataformat::TcRawData::Unconnected;
  ...
  TPGFEDataformat::TcRawData::Type type(unsigned lp, unsigned up) const {
  ...
  bool connected(unsigned lp, unsigned up) const {
    ...
    return _unpackerType[lp][up]!=TPGFEDataformat::TcRawData::Unconnected;
  }
  ...
  unsigned unpackerStreams(unsigned lp, unsigned up) const {
    ...
    if(_unpackerType[lp][up]==TPGFEDataformat::TcRawData::Unconnected) return 0;
  ...
  void print() const {
	...
	std::cout << " Type " << TPGFEDataformat::TcRawData::typeName(_unpackerType[lp][up])
...
protected:
  ...
  TPGFEDataformat::TcRawData::Type _unpackerType[MaximumLpgbtPairs][MaximumUnpackersPerLpgbtPair];
