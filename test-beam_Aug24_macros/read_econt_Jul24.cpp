...
int main(int argc, char** argv)
{
  ...
  std::map<uint64_t,std::vector<std::pair<uint32_t,Trig24Data>>> econtarray; //event,moduleId (from link)
  ...
  for(const auto& ievent : eventList){
    ...
    std::vector<std::pair<uint32_t,Trig24Data>> econtdata =  econtarray[ievent]; 
